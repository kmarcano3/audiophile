  ...
  return (
    <Container>
      <Box sx={{ display: "flex", margin: "10rem 0" }}>
        ...
        >
          <Typography variant="h4" sx={{ marginBottom: "1.5rem", fontSize: "3rem" }}>
          ...
          >
            ...
            destination for high end heaphones, earphones, speakers, and audio
            accessories. We have a large showroom with luxury demonstraion rooms
